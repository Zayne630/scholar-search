...
`,[N(`segment-type`,[L(`tabs-rail`,[b(`&.transition-disabled`,[L(`tabs-capsule`,`
 transition: none;
 `)])])]),N(`top`,[L(`tab-pane`,`
 ...
 display: flex;
 align-items: center;
 `),M(`prefix`,`padding-right: 16px;`),M(`suffix`,`padding-left: 16px;`)]),N(`top, bottom`,[b(`>`,[L(`tabs-nav`,[L(`tabs-nav-scroll-wrapper`,[b(`&::before`,`
 top: 0;
 bottom: 0;
 left: 0;
 width: 20px;
 ...
 box-shadow: inset -10px 0 8px -8px rgba(0, 0, 0, .12);
 `)])])])])]),N(`left, right`,[L(`tabs-nav-scroll-content`,`
 flex-direction: column;
 `),b(`>`,[L(`tabs-nav`,[L(`tabs-nav-scroll-wrapper`,[b(`&::before`,`
 top: 0;
 left: 0;
 right: 0;
 height: 20px;
 ...
 flex-grow: 0;
 flex-shrink: 0;
 `),N(`line-type, bar-type`,[L(`tabs-tab`,`
 ...
 `),N(`disabled`,{color:`var(--n-tab-text-color-disabled)`})])]),L(`tabs-nav`,[N(`line-type`,[N(`top`,[M(`prefix, suffix`,`
 ...
 width: 100%;
 `)])]),N(`top`,[N(`card-type`,[L(`tabs-scroll-padding`,`border-bottom: 1px solid var(--n-tab-border-color);`),M(`prefix, suffix`,`
 border-bottom: 1px solid var(--n-tab-border-color);
 `),L(`tabs-tab`,`
 ...
 `),L(`tabs-pad`,`
 border-bottom: 1px solid var(--n-tab-border-color);
 `)])]),N(`left`,[N(`card-type`,[L(`tabs-scroll-padding`,`border-right: 1px solid var(--n-tab-border-color);`),M(`prefix, suffix`,`
 border-right: 1px solid var(--n-tab-border-color);
 `),L(`tabs-tab`,`
 border-top-left-radius: var(--n-tab-border-radius);
 ...
 `),L(`tabs-pad`,`
 border-right: 1px solid var(--n-tab-border-color);
 `)])]),N(`right`,[N(`card-type`,[L(`tabs-scroll-padding`,`border-left: 1px solid var(--n-tab-border-color);`),M(`prefix, suffix`,`
 border-left: 1px solid var(--n-tab-border-color);
 `),L(`tabs-tab`,`
 border-top-right-radius: var(--n-tab-border-radius);
 ...
 `),L(`tabs-pad`,`
 border-left: 1px solid var(--n-tab-border-color);
 `)])]),N(`bottom`,[N(`card-type`,[L(`tabs-scroll-padding`,`border-top: 1px solid var(--n-tab-border-color);`),M(`prefix, suffix`,`
 border-top: 1px solid var(--n-tab-border-color);
 `),L(`tabs-tab`,`
 border-bottom-left-radius: var(--n-tab-border-radius);
 border-bottom-right-radius: var(--n-tab-border-radius);
